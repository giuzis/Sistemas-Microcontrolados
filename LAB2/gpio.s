...
;            STR     R1, [R0]						;Guarda no registrador
			LDR     R0, =GPIO_PORTK_AHB_DIR_R		;Carrega o R0 com o endereço do DIR para a porta F
...
;            STR     R1, [R0]						;Guarda no registrador PCTL da porta J da memória
            ...
            MOV     R1, #0x07               		;Colocar 0 no registrador DIR para funcionar com saída 01000000
            STR     R1, [R0]						;Guarda no registrador PCTL da porta J da memória
; 5. Limpar os bits AFSEL para 0 para selecionar GPIO 
;    Sem função alternativa
            MOV     R1, #0x00						;Colocar o valor 0 para não setar função alternativa
            LDR     R0, =GPIO_PORTK_AHB_AFSEL_R		;Carrega o endereço do AFSEL da porta F
...
; -------------------------------------------------------------------------------
; Função PortA_Output
; Parâmetro de entrada: R0 --> dados de entrada no LCD
; Parâmetro de saída: Não tem
...
; -------------------------------------------------------------------------------
; Função PortM_Output
; Parâmetro de entrada: R0 --> Controla EN, R/W e R
; Parâmetro de saída: Não tem
PortM_Output
